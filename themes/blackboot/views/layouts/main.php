				...
				<div class="nav-collapse">
					<?php $this->widget('application.extensions.mbmenu.MbMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Data Siswa', 'url'=>array(''), 'visible'=>!Yii::app()->user->isGuest,
							'items'=>array(
						array('label'=>'Kelola Siswa', 'url'=>array('/siswa/admin'), 'visible'=>!Yii::app()->user->isGuest),
						array('label'=>'Create Siswa','url'=>array('/siswa/create'),'visible'=>!Yii::app()->user->isGuest),
						array('label'=>'Cetak Siswa (.pdf)','url'=>array('/siswa/cetakSiswa'),'visible'=>!Yii::app()->user->isGuest),
						),
					),
							array('label'=>'Tentang Aplikasi', 'url'=>array('/site/page', 'view'=>'about')),
							array('label'=>'Kontak Kami', 'url'=>array('/site/contact')),
							array('label'=>'Login', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
							//array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>! cdYii::app()->user->isGuest)
						),
					)); ?>
	  ...
	  <div class="container">
		<div class="row">
			...
			<div id="footer-terms" class="col-md-6">
				© 2012-13 By. <a href="http://nachi.me.pn" target="_blank">Admin</a>.
			</div> <!-- /.span6 -->
		 </div> <!-- /row -->
	  </div> <!-- /container -->
	</div>
