...
class JenisKelaminController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['JenisKelamin'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_jkel));
		}
	...
	{
		$model=JenisKelamin::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param JenisKelamin $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='jenis-kelamin-form')
		{
